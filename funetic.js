  ...
  if (noot) {
    loodfooneem(function(dicsh, debug) {
      noot.tokens.forEach(toocn => {
        ...
        if (toocn.text.content.slice(-3).toLowerCase() != "ing") {
          // shoortening ruul for wrd ending in r
          ...
          toocn.fooneem = toocn.fooneem.replace(/JH (?:R|ER|ER0|ER1|ER2)$/, "JH R") // coorecting -jur in cmudict
          ...
          toocn.fooneem = toocn.fooneem.replace(/V (?:R|ER|ER0|ER1|ER2)$/, "V R") // coorecting -vur in cmudict
